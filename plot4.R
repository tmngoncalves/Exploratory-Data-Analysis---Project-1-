...
## This code create a png file named plot4.png.
png(filename="plot4.png",width=480,height=480,units="px")
## This code allows to have 2 plots per row and column.
par(mfrow=c(2,2),mar=c(4,4,2,2))
## This code generates the plot which shows the change of global active power 
## through time.
with(df,plot(Date_Time,Global_active_power,type="l",xlab="",
                                 ylab="Global Active Power"))
## This code generates the plot which shows the change of voltage
## through time. Note that the type "l" in this plot means it is going to be a 
## line (piecewise curve, where each piece is a line).
with(df,plot(Date_Time,Voltage,type="l",xlab="datetime",ylab="Voltage"))
## This code generates the plot which shows the change of energy submetering 
## through time for certain areas in a household: kitchen, laundry room, and 
...
## Note here the bty removes the legend box and cex decreases its default size.
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),
                     col=c("black","red","blue"),lty=c(1,1,1),bty="n",cex=0.75)
## This code generates a plot which shows the change o global reactive power 
## through time.
